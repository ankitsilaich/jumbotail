...
.config(["$stateProvider", function config( $stateProvider ) {
  $stateProvider.state( 'orders', {
    ...
    resolve: {
        auth: ["$q", "authenticationSvc", "$location", function ($q, authenticationSvc , $location) {
...
.controller( 'OrdersCtrl', ["$scope", "authenticationSvc", "$location", "auth", "$timeout", "Pagination", function OrdersCtrl( $scope ,authenticationSvc, $location, auth, $timeout, Pagination) {
